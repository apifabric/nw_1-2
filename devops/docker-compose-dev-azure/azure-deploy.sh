...
resourcename="nw1"  # lower case, only
resourcegroup="nw1_rg"
...
# git clone https://github.com/apilogicserver/nw1.git
# cd nw1
...
az group create --name nw1_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group nw1_rg --sku S1 --is-linux
az container create --resource-group nw1_rg --name nw1 --image apilogicserver/nw1:latest --dns-name-label nw1 --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//nw1.westus.azurecontainer.io:5656'
